...
class EventSurveyApiController extends ApiBaseController
{
    /**
    ...
    public function postEditEventQuestion(Request $request, $event_id, $question_id)
    {
        ...
        return response()->json([
            'status'      => 'success',
            'message'     => trans("Controllers.successfully_edited_question")
        ]);
    ...
    public function postDeleteEventQuestion(Request $request, $event_id)
    {
        ...
        if ($question->delete()) {
            ...
            return response()->json([
                'status'      => 'success',
                'message'     => trans("Controllers.successfully_deleted_question"),
            ]);
        }
