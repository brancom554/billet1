...
class EventOrdersApiController extends Controller
{
    ...
    public function showOrders(Request $request, $event_id = '')
    {
        ...
        if ($searchQuery) {
            ...
            $orders = $event->orders()->orderBy($sort_by, $sort_order)->paginate(25);
        }
    ...
    public function postEditOrder(Request $request, $order_id)
    {
        ...
        return response()->json([
            'status'      => 'success',
            'message' => trans("Controllers.the_order_has_been_updated"),
        ]);
    }
    ...
    public function postCancelOrder(Request $request, $order_id)
    {
        ...
        return response()->json([
            'status' => 'success',
            'message' => trans("Controllers.successfully_refunded_and_cancelled"),
        ]);
    }
    ...
    public function postMarkPaymentReceived(Request $request, $order_id)
    {
        ...
        return response()->json([
            'status' => 'success',
            'message' => trans("Controllers.order_payment_status_successfully_updated")
        ]);
    }
}
