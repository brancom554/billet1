...
class EventAttendeesApiController extends ApiBaseController
{
    /**
    ...
    public function showInviteAttendee(Request $request, $event_id)
    {
        ...
        if ($event->tickets->count() === 0) {
            return response()->json([
                'status'  => 'success',
                'message' => trans("Controllers.addInviteError"),
            ],200);
        }
    ...
    public function postInviteAttendee(Request $request, $event_id)
    {
        ...
        try {
            ...
            return response()->json([
                'status'      => 'success',
                'event_id' => $event_id,
                'message', trans("Controllers.attendee_successfully_invited")
            ]);
    ...
    public function postImportAttendee(Request $request, $event_id)
    {
        ...
        return response()->json([
            'status'      => 'success',
            'event_id' => $event_id,
            'message', 'Attendees Successfully Invited'
        ]);
    }
    ...
    public function postCancelAttendee(Request $request, $event_id, $attendee_id)
    {
        ...
        return response()->json([
            'status' => 'success',
            'id' => $attendee->id,
            'message'=> trans("Controllers.successfully_cancelled_attendee")
        ]);
    }
